...
public class CarsalessystemApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Customer c1 = Customer.builder().customerId(1000).cname("shreya").email("shreya@gmail.com").phoneNumber(8454386798d).address("pune").build();
...
//		Customer c2 = Customer.builder().cname("vaishnavi").email("vaish@gmail.com").phoneNumber(9254386798d)
